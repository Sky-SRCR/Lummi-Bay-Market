...
// (ADR-0008). The other three each run the page under a premise about who is at
...
function buildFixture() {
    ...
    const img = renderBlock({
        type: 'image', block_subtype: 'free', x_pos: 700, y_pos: 40, width: 220, height: 160,
...
// ============================================================
// The canvas background is left alone on purpose (ADR-0008): an uploaded one lives
