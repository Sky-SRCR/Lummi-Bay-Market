...
<div class="help-section" id="inspector">
    ...
    <ul>
        ...
        <li><strong>Hide from the screens</strong> (admin only) — takes the block off every screen showing this display while keeping it in the layout, ready to bring back by unticking. Hiding a <strong>section</strong> hides everything inside it. Hidden blocks are faded on the canvas and wear a red HIDDEN band, so you can see at a glance what a customer cannot. A hidden block is not sent to the screens at all — not sent and then skipped, but left out of what the screen is given — so a price staged for next week cannot be read off the display's feed either. Unlike the Work Area's Hide, this takes effect when you <strong>Publish</strong>.</li>
...
<div class="help-section" id="admin">
    ...
    <ul>
        ...
        <li><strong>Deleting is refused while somebody else has the display open in the Builder</strong>, and the message names them. This is not the same warning as the element count beside it: that count is what has been <em>published</em>, and somebody mid-edit also has a canvas that has never reached a screen and that nothing on this page can see. Their own copy of it would vanish with no warning to them. Wait until they are finished — a Builder left idle lets go of the display after 15 minutes — or open it in the Builder yourself and take the edit over first. Your <em>own</em> Builder tab does not stop you.</li>
