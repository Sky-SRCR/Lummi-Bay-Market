...
function renderBlock(el, parent, isNew) {
    ...
    // Empty for a block createBlock() just made, and the id for one that came out of
    // the database. That difference is the whole of how a publish tells "I am sending
    // back the root block that was already here" from "I invented one", which is what
    // a basic account may not do (ADR-0005). Sections have carried it all along.
