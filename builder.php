...
// How far back Undo may go on this page (ADR-0008), from the admin Settings page
// by way of config.php. Zero on a read-only Builder as well as when the setting
// says zero: a page that may not change anything has nothing to take back, and
// this is the one number the button, the shortcut and the snapshots all read —
// so switching it off switches off all three rather than two of them.
...
<div id="inspector">
    ...
    <!-- Font controls (admin only, free text)
         ...
         the browser saying the person has finished choosing. See ADR-0008. -->
...
// How many steps back Undo may go, from the admin Settings page (ADR-0008). Zero
...
function handleBuilderKeydown(e) {
    ...
    // edit is one step and this takes it back (ADR-0008).
...
// leaves the background alone. ADR-0008 has the rest.
