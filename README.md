...
| `lib/login_gate.php` | `LoginGate` — every sentence a refused sign-in may say, and the lockout arithmetic behind it (ADR-0008) |
| `lib/request_scheme.php` | `RequestScheme` — is this request HTTPS, and may the session cookie claim `Secure` (ADR-0009) |
