...
// says which was meant. This app was stated to run 8.2, so the strict behaviour is
// what it gets today (#51, §4k) — which is exactly the situation where "the default is
// fine now" is the assumption not to leave lying around, because it is true until the
// host moves and says nothing when it does. Both flags are named here so the behaviour
// is identical on either side of 8.1 and does not depend on the version at all.
//
